...
<div class="main">
    <div class="page-container gallery-page-container">
        <h2>Our Customer's Gallery</h2>
        <p class="main-description">Wondering how our food looks in a real event environment? Or you just want to get inspired by others for your own event? Take a look at our customer's gallery and get inspired!</p>
        <div class="gallery-slider-wrapper">
            <div class="item">
                <img src="/wp-content/uploads/2024/02/customer-gallery-image-1.png" alt="Customer image">
                <p class="slide-description">Birthday celebration party</p>
            </div>
            <div class="item">
                <img src="/wp-content/uploads/2024/02/customer-gallery-image-1.png" alt="Customer image">
                <p class="slide-description">Birthday celebration party</p>
        ...
        <div class="footer">
            <p>Want to see your special event with Nougatine catering on our website? Use hashtag #nougatine on Instagram and Facebook.</p>
            <div class="social-media">
                ...
                <a href="#" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <g clip-path="url(#clip0_31_11406)">
