        ...
        <div class="container">
            ...
            foreach ( $product_categories as $category ) {
                ...
                if ( $products->have_posts() ) {
                    ...
                    echo "<span class='category-anchor' id='".esc_html($category->slug)."'></span>";

                        while ( $products->have_posts() ) {
                            $products->the_post();
                            $price = get_post_meta( get_the_ID(), '_price', true );
                            $products_arr = ['id' => get_the_ID(), 'name' => get_the_title(), 'price' => $price];
