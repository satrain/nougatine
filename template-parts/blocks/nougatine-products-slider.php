    ...
    <div class="container">
        ...
        <div class="best-sellers-slider">
            ...
            foreach($products as $product): 
                ...
                $products_arr = ['id' => $product->ID, 'name' => $product->post_title, 'price' => $price];
                get_template_part( 'template-parts/content', 'product', $products_arr );
            endforeach; 
            ?>
        </div>
        <?php if(!empty($button)): ?><a href="<?= $button['url'] ?>" class="btn btn-primary explore-our-products-btn"><?= $button['title'] ?></a><?php endif; ?>
    </div>
</div>
